...
class TransactionStatus {
	@ApiProperty({ enum: EnumTransactionStatus, description: "", example: EnumTransactionStatus.SUCCEEDED })
...
export class GetAllOrdersResponse {
	...
	@ApiProperty({ enum: EnumOrderStatus, description: "", example: EnumOrderStatus.PENDING })

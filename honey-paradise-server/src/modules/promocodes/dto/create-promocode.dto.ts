...
export class CreatePromoCodeDto {
  ...
  @ApiProperty({
    enum: EnumPromoTokenTypes,
    example: EnumPromoTokenTypes.PERSONAL,
  })
  @IsNotEmpty({ message: "" })
  ...
  @ApiProperty({
    enum: EnumPromoTokenDiscountType,
    example: EnumPromoTokenDiscountType.ALL,
  })
  @IsNotEmpty({ message: "" })

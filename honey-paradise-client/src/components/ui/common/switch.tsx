...
const Switch = forwardRef<
	...
	ComponentPropsWithoutRef<typeof SwitchPrimitives.Root> & { isLoading?: boolean }
>(({ className, disabled, isLoading, title, ...props }, ref) => {
	const t = useTranslations("shared.ui.switch");
	const _title = props.checked ? t("disable", { txt: title || "" }) : t("enable", { txt: title || "" });
	...
	return (
		...
		>
			...
			{isLoading && <LoaderIcon size={20} className={styles["switch-loader-ui"]} />}
		</SwitchPrimitives.Root>
	);
});

		...
		<>
			...
			<div className={styles["footer-socials"]}>
				...
				<div className={styles["socials-wrapper"]}>
					...
					<Link
						href={googleLink}
						title={t("labels.google")}
						className={styles["socials-google"]}
					>
						<Image
					...
					<Link
						href={yandexLink}
						title={t("labels.yandex")}
						className={styles["socials-yandex"]}
					>
						<Image
					...
					<Link
						href={githubLink}
						title={t("labels.github")}
						className={styles["socials-github"]}
					>
						<Image

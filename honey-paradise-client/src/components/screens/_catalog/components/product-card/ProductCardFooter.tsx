	...
	return (
		<div className="flex items-center gap-3">
			...
			{isAuthenticated && (
				...
				>
					<div className="absolute left-1/2 top-1/2 h-0.5 w-0 -translate-x-1/2 -translate-y-1/2 -rotate-45 bg-red-500 transition-all" />
					<HeartIcon
						size={24}
						className={cn(
							"fill-transparent stroke-red-500 transition-colors will-change-auto",
							{

...
const PermissionsSection: FC<IProps> = ({
	isAccLoading,
	isEnabled,
	isWithSound
}) => {
		...
		>
			<Title size="sm">
				...
				<a
					...
					id={slugify(t("permissions.title"), { locale: "en", lower: true })}
				/>
			</Title>
			...
			<div className={styles["switch-wrapper"]}>
				...
				<div>
					...
					<span data-permission={permission}>
						{t("permissions.push.permitted", { permission })}
					</span>

import { Button, DropdownMenu, DropdownMenuContent, DropdownMenuTrigger } from "@/components/ui/common";
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger disabled={comment.length === 0} asChild>
				<Button variant="ghost" className="ml-2 p-2 hover:!bg-muted/30" title="Предпросмотр текста" disabled={comment.length === 0}>

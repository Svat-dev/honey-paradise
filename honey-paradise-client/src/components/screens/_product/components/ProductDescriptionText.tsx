...
const ProductDescriptionText: FC<IProps> = memo(({ category, description, rating, reviews, locale }) => {
	...
	return (
		<>
			...
			<m.p {...getProps(1)}>
				...
				{description ? description[locale as keyof ApiJsonValue] : t("description.text.noDesc")}
			</m.p>
